...
function renderArticles(articles) {
    ...
    articles.forEach(function (article) {
        ...
        section.innerHTML = "\n      <h2>".concat(article.title, "</h2>\n      <p>").concat(article.intro, "</p>\n      <a href=\"articles/").concat(article.id, ".html\">\u010C\u00EDst cel\u00FD \u010Dl\u00E1nek</a>\n    ");
        container.appendChild(section);
    });
}
function loadArticles(filter) {
    return __awaiter(this, void 0, void 0, function () {
        var res, all, filtered;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch('/articles.json')];
                case 1:
                    res = _a.sent();
                    return [4 /*yield*/, res.json()];
                case 2:
                    all = _a.sent();
                    filtered = filter === "all" ? all : all.filter(function (a) { return a.category === filter; });
